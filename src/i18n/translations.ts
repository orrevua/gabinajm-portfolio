...
export const translations = {
  en: {
    ...
    about: {
      ...
      homeAboutSummary: "A Product Designer with 10+ years of experience creating accessible, user-centered digital experiences. Specialized in UX/UI and accessibility, I transform complex challenges into simple and intuitive solutions.",
      bio: [
  ...
  pt: {
    ...
    about: {
      ...
      homeAboutSummary: "Product Designer com mais de 10 anos de experiência criando experiências digitais acessíveis e centradas no usuário. Especializada em UX/UI e acessibilidade, transformo desafios complexos em soluções simples e intuitivas.",
      bio: [
