      ...
      of: [
        ...
        },
        {
          ...
          fields: [
            ...
            defineField({ name: 'resumeUrl', title: 'Resume URL', type: 'url', description: 'External link to resume — preferred when set (e.g. LinkedIn-hosted PDF)' }),
            defineField({ name: 'resumeFile', title: 'Resume File', type: 'file', description: 'Upload resume/CV (PDF) — used only if Resume URL is empty', options: { accept: 'application/pdf' } }),
